...
# colored hyperlink text,clickable icons,text bar field,clickable UI buttons,UI tabs,Interactive UI Elements,blue text hyperlink,X
#0.1
...
def history_modifier(history):
    ...
    compressed_results_json_path = "extensions/Lucid_Autonomy/ImageOutputTest/results.json"
    with open(compressed_results_json_path, 'r') as f:
        compressed_results = json.load(f)
